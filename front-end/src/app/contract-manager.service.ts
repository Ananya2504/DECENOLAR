...
export class ContractManagerService {
  ...
  raiseRideRequest() {
    ...
    return this.http.post('http://localhost:8080/api' + '/raiseRequest', rideInfo);
  }

  checkRideRequestStatus() {
    return this.http.get('http://localhost:8080/api' + '/checkRequestStatus/' + this.account);
  }
  ...
  getOptimalRide() {
    ...
    return this.http.post('http://localhost:8080/api' + '/getOptimumRideRequest', temp);
  }
  ...
  acceptRide() {
    ...
    return this.http.post('http://localhost:8080/api' + '/acceptRide', temp);
  }
  ...
  checkRideStatusAndCompleteDriver() {
    ...
    return this.http.post('http://localhost:8080/api' + '/checkRideStatusAndCompleteDriver', reqBody);
  }
  confirmRideCompleteRider() {
    let reqBody = {
      "_id": this.rideManager.ride_data._id
    }
    return this.http.post('http://localhost:8080/api' + '/confirmRideCompleteRider', reqBody);
  }
}
